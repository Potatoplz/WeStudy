				...
				<body id="kt_body" class="header-fixed subheader-enabled page-loading">
					<form class="form">
						...
						<div class="d-flex flex-column flex-root">
														...
														<div class="d-flex align-items-baseline flex-wrap mr-5">
															...
															<ul
																...
																<li class="breadcrumb-item">
																	<a href="/member/myPage?r_Idx=${member.member_name}"
																		class="text-muted">회원 정보</a>
																</li>
															</ul>
															<!--Breadcrumb : 로드맵 종료-->
														</div>
														...
														<div class="d-flex mb-9">
															...
															<div class="flex-shrink-0 mr-7 mt-lg-0 mt-3">
																<div class="symbol symbol-50 symbol-lg-120">
																	<img src="${member.member_profile}" alt="image"
																		class="object-cover" />
																</div>
																<div
																	...
																	<span
																		...
																		${fn:substring(member_Name,0,1)} </span>
																</div>
															</div>
															<!--수정기능 있는 버전-->
															<%--<div class="flex-shrink-0 mr-7 mt-lg-0 mt-3">
														...
														<div class="flex-grow-1">
															...
															<div class="d-flex justify-content-between flex-wrap mt-1">
																<div class="d-flex mr-3 align-items-center">
																	...
																	<span
																		class="text-dark-75 text-hover-primary font-size-h5 font-weight-bold mr-3">${member.member_name}님</span>

																	<c:if
																		test="${(sessionScope.member.member_name == member.member_name) || (sessionScope.kname == member.member_name)}">
																		<i
																			class="flaticon2-correct text-success font-size-h5 align-self-center"></i>
																...
																<div class="my-lg-0 my-3">
																	<a href="#"
																		class="btn btn-sm bg-ssff1 bg-hover-danger-o-1 font-weight-bolder text-uppercase mr-3">프로젝트
																		찾기</a>
																	<a href="#"
																		class="btn btn-sm bg-ssff2 bg-hover-danger-o-1 font-weight-bolder text-uppercase mr-3">스터디
																		찾기</a>
																</div>
																<%--<div
																	class="d-flex1 align-items-center w-70 flex-fill float-right mt-lg-12 mt-8">
																	<button type="button" id="modifyMember"
																		onclick="fn_modify();"
																		class="btn btn-primary font-weight-bolder font-size-h5 pl-9 pr-9 py-4 my-5 ">
																		정보수정
																	</button>
																	<button type="button" id="findPJ"
																		onclick="fn_findPJ();"
															...
															<div class="d-flex flex-column flex-grow-1 pr-8">
																<div class="d-flex flex-wrap mb-4">
																	<a href="#"
																		...
																		<i
																			class="flaticon2-new-email mr-2 font-size-lg"></i>${member.member_id}
																	</a>
																	<a href="#"
																		class="text-dark-50 text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
																		<i
																			class="flaticon2-calendar-3 mr-2 font-size-lg"></i>${member.member_no}
																	</a>
																</div>
																<span
																	class="font-weight-bold text-dark-50">${member.member_introduce}</span>
															</div>
														</div>
														<!--end::Content-->
													</div>
											...
											<div class="card-body">
												...
												<div class="calmodal hidden">
													...
													<div class="calmodal-content">
														...
														<div id="cal-time-sec">
															<div class="cal-index" style="display:inline-block">일시
															</div>
															<label>종일</label><input type="checkbox" id="allday"
																name="allday" checked>
															<br>
															<input type="date" id="calendar-start-date" name="cal_start"
																class="form-control inputBoxSetting1">
															<span>&nbsp;&nbsp;~</span>
															<input type="date" id="calendar-end-date" name="cal_end"
																class="form-control inputBoxSetting1">
															<br>
															<br>
															<div class="timeHidden hidden">
																<label for="calendar-start-time">시작</label><input
																	type="time" id="calendar-start-time" step="900"
																	required class="form-control inputBoxSetting2">
																<label for="calendar-end-time">종료</label><input
																	type="time" id="calendar-end-time" step="900"
																	required class="form-control inputBoxSetting2">
															</div>
														</div>
														<div id="cal-cont-sec">
														...
														<div id="cal-button-sec">
															...
															<button id="modal-modify" class="hidden cal-button"
																onclick="modifyEvent()">수정
															</button>
															<button id="modal-delete" class="hidden cal-button"
							...
							<!--컨테이너 종료-->
							<!--footer.html Include-->
							<jsp:include page="${pageContext.request.contextPath}/WEB-INF/commons/footer.jsp">
							</jsp:include>
