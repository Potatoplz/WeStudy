...
<!-- 						         <div class="card-target col-sm-6 mb-4"> -->
<!-- 						            <div class="card"> -->
								            ...
								            +"<div class='card2'>"
								                +"<div class='card-body d-flex justify-content-between;>"
								                   +"<div class='content d-flex align-items-center justify-content-between'>"
								                    ...
								                    +"<div class='action border-left pl-3 d-flex align-items-center'>"
								                        +"<div>"
								                            +"<a href='#!' class='btn btn-outline-danger btn-block btn-sm' id='no'>"+ "거절" +"</a>"
								                            +"<a href='#!' class='btn btn-outline-success btn-block btn-sm' id='yes'>"+ "수락" +"</a>"
								                        +"</div>"
								                    +"</div>"
								                +"</div>"
								            +"</div>"
