              ...
              <div class="row">
                <div class="col-12 ">
                  ...
                  <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    <div class="tab-pane fade" id="nav-home-detail" role="tabpanel" aria-labelledby="nav-home-detail-tab">  	
					...
					, function(data, status) {
						...
						$.each(data, function(index, dto) {
							...
							let str1 = "<tr>"
								...
								+ "<td><a href='${pageContext.request.contextPath}/study/my_detail?study_id=" + dto.study_id + "'>"
									+ dto.study_name + "</a></td>"
								+ "<td>" + dto.start_date + "</td>"
								+ "<td><a href='${pageContext.request.contextPath}/study/mystudy_state?study_id=" + dto.study_id + "'>"
									+ dto.study_state + "</td>"
