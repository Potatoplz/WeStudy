...
<body>
	...
	<div id="mySidenav" class="sidenav">
		...
		<a href="${pageContext.request.contextPath}/cafe/wish_list">찜 리스트</a>
                      ...
                      <div class="search-input-wrap">
                        <div class="input-round">
                           <form action="${pageContext.request.contextPath}/study/main" method="get">
                              ...
                              <input class="search-box" type="text" id="searchWord" name="searchWord"
								value="${search_dto.searchWord}" placeholder="검색어를 입력하세요." autocomplete="off"
                              />
                              </div>
                            ...
                            <c:choose>
								...
								<c:otherwise>
									<a href="${pageContext.request.contextPath}/cafe/wish_list">
					                    <div class="item sm-bar cart-icon">
					                       <img src="//cdn.ggumim.co.kr/resource/icons/ic_cart_black.png"
					                       style="width: 20px; height: 28px; vertical-align: top; margin-top:26px;"
					                       />
					                    </div>
					               </a>
								</c:otherwise>
